...
2. Use Java 17
3. Run `NikeShoeShopApplication`
4. Open `http://localhost:8080`

## MySQL profile
If you want to use MySQL instead of the default H2 database, activate the `mysql` profile and update `src/main/resources/application-mysql.properties`.
